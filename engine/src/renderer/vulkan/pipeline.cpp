...
namespace ic
{
        ...
        bool pipeline::create(VkDevice device, VkRenderPass renderPass, const pipeline_layout& layout,
                              const pipeline_config& config)
        {
                ...
                // Layout + render pass
                pipelineInfo.layout     = layout.get(); // VkPipelineLayout from your wrapper
                pipelineInfo.renderPass = renderPass;
                pipelineInfo.subpass    = 0; // usually 0 unless multipass
        ...
        void pipeline_config::create(const VkShaderModule& vertShaderModule, const VkShaderModule& fragShaderModule,
                                     const VkExtent2D& swapchainExtent)
        {
                ...
                VkVertexInputAttributeDescription colorAttributeDescription = vertex::getColorAttributeDescription();
                ...
                rasterizer.polygonMode =
                    VK_POLYGON_MODE_FILL; // this is responsible for different kind of modes for wireframes. requires
                                          // gpu feature for other modes. LINE and POINt Fill
