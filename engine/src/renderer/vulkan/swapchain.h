...
namespace ic
{
    ...
    private:
        ...
        logical_device* m_device = nullptr;
        vulkan_surface* m_surface = nullptr;
    ...
    public:
        ...
        bool create(logical_device& device, vulkan_surface& surface, VkSwapchainKHR oldSwapChain = VK_NULL_HANDLE);
        void destroy();
