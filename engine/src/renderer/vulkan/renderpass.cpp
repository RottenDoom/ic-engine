...
namespace ic
{
        ...
        bool RenderPass::create(VkDevice device,
                                ...
                                const VkAllocationCallbacks* callback)
        {
                ...
                colorAttachment.loadOp  = VK_ATTACHMENT_LOAD_OP_CLEAR;  // load, clear or don't care before and after
                                                                        // rendering.
        ...
        void RenderPass::moveFrom(const RenderPass&& other) noexcept
        {
        ...
        void RenderPass::destroy(VkDevice device, const VkAllocationCallbacks* callbacks)
        {
        ...
        RenderPass& RenderPass::operator=(const RenderPass&& other) noexcept
        {
                if (this != &other)
                {
                        m_renderPass           = VK_NULL_HANDLE;
        ...
        RenderPass::RenderPass(const RenderPass&& other) noexcept
        {
