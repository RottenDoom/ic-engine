...
namespace ic
{
RenderScene::RenderScene(const string &name) : m_Name(name) {}
...
bool RenderScene::SetParent(Entity child, Entity parent)
{
        ...
        auto &childHierarchy = child.HasComponent<HierarchyComponent>() ? child.GetComponent<HierarchyComponent>()
                                                                        : child.AddComponent<HierarchyComponent>();

        auto &parentHierarchy = parent.HasComponent<HierarchyComponent>() ? parent.GetComponent<HierarchyComponent>()
